...
public class MyCellView {
    ...
    public static void main(String[] args) {
        ...
        cells[0] = createVertex(20, 20, 60, 30, Color.BLUE, false, new DefaultGraphCell("hello"), "JGraphEllipseView");
        ...
        cells[3] = createVertex(140, 140, 60, 30, Color.ORANGE, false, new DefaultGraphCell("world"), "JGraphRoundRectView");
